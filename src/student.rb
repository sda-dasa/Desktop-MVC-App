class Student
	...
	attr_reader :id, :first_name, :last_name, :surname, :git, :phone, :mail, :tg
...
tom = Student.new("Tom", "Elephant", "", "89161234567", "", "killer120-1989@mail.ru","Ivan(Ivanov)")
puts tom.id
puts tom. last_name_initials
tom.git= "Ivan (Ivanov) 2000"
puts tom.has_tg?
puts tom.git
puts tom.to_s
contacts = {phone: "89991234567", mail: "ivan@example.com", tg: "@killer"}
tom.contact contacts
puts tom.to_s